...
import {
  useSendAudioChunk as useDetectFingerprint,
  useUploadFingerprint as useStoreFingerprint,
} from '../hooks/useAudio';
...
export default function PlaygroundPage() {
  ...
  const { data: fingerprintResult, fetch: detectFingerprint } =
    useDetectFingerprint();
